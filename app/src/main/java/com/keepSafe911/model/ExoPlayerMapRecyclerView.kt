...
class ExoPlayerMapRecyclerView : RecyclerView {

    private var videoInfoList: FeedResponseResult = FeedResponseResult()
    ...
    fun setVideoInfoList(videoInfoList: FeedResponseResult) {
    ...
    fun playVideo() {
        ...
        if (videoInfoList.fileType == 1){
            ...
            val holder: NeighbourMapFragment.NeighbourMapAdapter.NeighbourHolder
            if (child.tag == null) {
                playPosition = -1
                return
            } else {
                holder = child.tag as NeighbourMapFragment.NeighbourMapAdapter.NeighbourHolder
            }
            ...
            val frameLayout = holder.itemView.findViewById<FrameLayout>(R.id.flPostFileVideoOld)
            ...
            val uriString = videoInfoList.file
            if (uriString != null) {
...
//                    playVideo()
    ...
    companion object {
        private const val TAG = "ExoMapRecyclerView"
    }
