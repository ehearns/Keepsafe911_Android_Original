package com.keepSafe911.datarecorder;
...
public class ViewRecorder extends SurfaceMediaRecorder {
    ...
    private TextureView mRecordedView;
...
//            mRecordedView.buildDrawingCache();
     ...
     */
    public void setRecordedView(@NonNull TextureView view) throws IllegalStateException {
        mRecordedView = view;
    }
}
