...
import com.keepSafe911.application.KeepSafe911Application
import io.agora.rtc.IRtcEngineEventHandler
import io.agora.rtc.RtcEngine

abstract class BaseActivity : AppCompatActivity(), EventHandler {
    protected var mDisplayMetrics: DisplayMetrics = DisplayMetrics()
    ...
    private fun setGlobalLayoutListener() {
        val layout: View = findViewById<View>(Window.ID_ANDROID_CONTENT)
        val observer: ViewTreeObserver = layout.viewTreeObserver
    ...
    protected fun application(): KeepSafe911Application {
        return application as KeepSafe911Application
    }
