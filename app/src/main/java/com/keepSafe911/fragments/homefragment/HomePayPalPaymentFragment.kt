...
import com.keepSafe911.fragments.commonfrag.HomeDialogBaseFragment
...
class HomePayPalPaymentFragment : HomeDialogBaseFragment() {
        ...
        wvPayPalPayment.webViewClient = object : WebViewClient() {
            override fun onPageStarted(view: WebView, url: String, favicon: Bitmap?) {
                ...
                if (url.lowercase().contains("https://keepsafe911.com") ||
                    ...
                    if (this@HomePayPalPaymentFragment::paymentOptionListener.isInitialized) {
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String = "") =
            HomePayPalPaymentFragment().apply {
