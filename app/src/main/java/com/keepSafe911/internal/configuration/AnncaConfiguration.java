...
public final class AnncaConfiguration {
    ...
    public interface Arguments {
        String REQUEST_CODE = "com.keepSafe911.request_code";
        String MEDIA_ACTION = "com.keepSafe911.media_action";
        String MEDIA_QUALITY = "com.keepSafe911.camera_media_quality";
        String VIDEO_DURATION = "com.keepSafe911.video_duration";
        String MINIMUM_VIDEO_DURATION = "com.keepSafe911.minimum.video_duration";
        String VIDEO_FILE_SIZE = "com.keepSafe911.camera_video_file_size";
        String VIDEO_AUTO_START = "com.keepSafe911.camera_video_auto_start";
        String SEND_MAIL = "com.keepSafe911.send_mail";
        String FLASH_MODE = "com.keepSafe911.camera_flash_mode";
        String FILE_PATH = "com.keepSafe911.camera_video_file_path";
        String CAMERA_FACE = "com.keepSafe911.camera_face";
        String MEDIA_RESULT_BEHAVIOUR = "com.keepSafe911.media_result_behaviour";
    }
    ...
    private boolean autoRecordVideo = false;
    ...
    public static class Builder {
        ...
        public Builder setAutoRecord(boolean autoRecord) {
            anncaConfiguration.autoRecordVideo = autoRecord;
            return this;
        }

        public Builder setSendMail(boolean sendMail) {
            anncaConfiguration.sendEmail = sendMail;
            return this;
        }
