package com.keepSafe911.internal.manager.impl;
...
import com.keepSafe911.internal.utils.ImageSaver;
...
public final class Camera2Manager extends BaseCameraManager<String, TextureView.SurfaceTextureListener, CaptureRequest.Builder, CameraDevice>
                    ...
                    try {
                        ...
                        cameraDevice.createCaptureSession(surfaces, new CameraCaptureSession.StateCallback() {
                            ...
                            public void onConfigured(@NonNull CameraCaptureSession cameraCaptureSession) {
                                ...
                                try {
                                    videoRecorder.start();
                                } catch (Exception videoRecorderException) {
                                    Log.e(TAG, "videoRecorder.start(): ", videoRecorderException);
                                }
    ...
    protected boolean prepareVideoRecorder() {
        ...
        try {
            ...
            if (configurationProvider.getMinimumVideoDuration() > 0) {
                videoRecorder.setMaxDuration(configurationProvider.getMinimumVideoDuration() * 1000);
                videoRecorder.setOnInfoListener(this);
            }
    ...
    private void setFlashModeAndBuildPreviewRequest(@AnncaConfiguration.FlashMode int flashMode) {
        try {
            ...
            Log.e(TAG, "Error setting flash: ", flashException);
        }
    }
