...
abstract public class AnncaCameraActivity<CameraId> extends Activity
    ...
    private void setUserContent() {
        ...
        customView = getUserContentView(LayoutInflater.from(this), userContainer);
    ...
    public final void setCameraPreview(View preview, Size previewSize) {
        ...
        if (customView!=null) {
            if (customView instanceof CameraControlPanel){
                ((CameraControlPanel) customView).autoStartVideo();
            }
        }
    }
