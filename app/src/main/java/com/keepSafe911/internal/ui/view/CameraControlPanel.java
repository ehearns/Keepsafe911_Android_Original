package com.keepSafe911.internal.ui.view;
...
import com.keepSafe911.internal.utils.DateTimeUtils;
...
public class CameraControlPanel extends RelativeLayout
    ...
    private boolean autoStartVideoRecord;
...
//                if (settingsClickListener != null) settingsClickListener.onSettingsClick();
    ...
    public boolean isAutoStartVideoRecord() {
        return autoStartVideoRecord;
    }

    public void setAutoStartVideoRecord(boolean autoStartVideoRecord) {
        this.autoStartVideoRecord = autoStartVideoRecord;
    }
    ...
    public void autoStartVideo() {
        if (autoStartVideoRecord) {
            Handler handler = new Handler();
            handler.postDelayed(new Runnable() {
                @Override
                public void run() {
                    recordButton.autoStartVideoRecord();
                }
            }, 2500);
        }
    }
